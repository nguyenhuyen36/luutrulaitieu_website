...
<body>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo number_format($row['Tong_tien']); ?></td>
						<td>
							<?php
							if ($row["status"] == 1) {
								echo "<a href='invoice_delivery.php?invoiceId=" . $row["idhoadon"] . "'> chờ duyệt</a>";
							} else {
								echo "Hoàn thành";
							}
							?>
	...
	<footer style="height: 50px; min-height: 50px; line-height: 50px; text-align: center">
		<div class="content-center">
			Hệ thống được bảo trợ bởi Vũ Châu - Expensix Store Việt Nam | Mọi chi tiết liên hệ Admin Vũ Châu, Hotlline: 0336091630
		</div>
	</footer>
</body>
